...
(SELECT Judge.FirstName, Judge.LastName, Judge.IDJudge FROM Judge INNER JOIN RaceJudge ON Judge.IDJudge = RaceJudge.IDJudge WHERE RaceJudge.IDRace=?) JudgeSelect 
